...
function findWorkspacePackages() {
    return __awaiter(this, void 0, void 0, function* () {
        const sentinel = yield (0, common_1.findSentinel)();
        if (!sentinel) {
            return [];
        }
        const { findWorkspacePackages } = yield (0, common_1.getImplementation)(sentinel);
        return yield findWorkspacePackages(sentinel);
    });
}
